...
if(isset($_POST['approve'])){
  try{
    ...
    $query = $conn->prepare("UPDATE leave_tb SET status = 'APPROVED' WHERE leave_id = :leave_id");
    ...
    <div class="panel panel-primary">
      ...
      <div class="panel-body">
        <form action="" method="post">
          ...
          <input type="submit" name="approve" class="btn btn-primary" value="APPROVE LEAVE DAYS">
