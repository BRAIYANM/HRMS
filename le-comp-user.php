...
if(isset($_POST['submit_com'])){
    try {
          ...
          header('Location: le-comp-user.php?action=concern/complain submited');
			exit;
          ...
          <div class="add-tab left card-4">
            <form method="post" class="u-form">
              ...
              <div class="col-md-12">
                ...
                <button type="submit" class="btn btn-primary le-btn" name="submit_com">SUBMIT COMPLAIN | CONCERN <i class="fa fa-send"></i></button>
              </div>
            </form>
          </div>
        </div>
